...
namespace Options_Pattern_ile_Dependency_Injection
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            // burada konteynýrýmýzýn içine ekledik. Konteynýr var zaten en üstte çekmiþ otomatik
            // biz de burada içine mail infoyu ekledik bu sayede uygulamanýn herhangi bir yerinden direk çekebiliriz.
            // --> Homecontrollera dön
